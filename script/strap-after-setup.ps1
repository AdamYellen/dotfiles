...
function AddToUserPath {
   ...
   # Write-Host "Adding $folder to PATH..." -ForegroundColor "Green"
...
Read-Host -Prompt "This script requires user input and interaction -- Press Return to continue after system is ready"

# Do we have winget yet?
while (-Not (Check-Command -cmdname 'winget')) {
